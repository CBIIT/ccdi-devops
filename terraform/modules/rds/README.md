...
| <a name="input_db_subnet_id_name"></a> [db\_subnet\_id\_name](#input\_db\_subnet\_id\_name) | db\_subnet\_id\_name | `string` | n/a | yes |
...
| <a name="input_jenkins_ip"></a> [jenkins\_ip](#input\_jenkins\_ip) | jenkins slave IP | `list(string)` | `[]` | no |
...
| <a name="input_subnet_id_name"></a> [subnet\_id\_name](#input\_subnet\_id\_name) | n/a | `string` | `""` | no |
