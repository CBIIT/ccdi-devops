...
| <a name="input_s3_bucket_arn"></a> [s3\_bucket\_arn](#input\_s3\_bucket\_arn) | the ARN of the S3 bucket to which the canary will write results to or read scripts from | `string` | n/a | yes |
