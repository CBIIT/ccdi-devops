...
| [aws_iam_role_policy_attachment.kinesis_firehose_delivery_stream](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/iam_role_policy_attachment) | resource |
...
| <a name="input_s3_bucket_arn"></a> [s3\_bucket\_arn](#input\_s3\_bucket\_arn) | the arn of the s3 bucket to deliver failed messages to | `string` | n/a | yes |
